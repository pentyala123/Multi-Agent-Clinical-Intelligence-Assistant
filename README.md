...
Developed by **Meghana Pentyala** as a portfolio implementation of a production-oriented life sciences multi-agent system with LangGraph, RAG, Weaviate, FastAPI, and MCP schemas.
